...
export const CreateEmployeeAccount: FC<RegisterProps> = () => {
  ...
  const onSubmit = (e: { preventDefault: () => void }) => {
    ...
    axiosPrivate
      .post(REGISTER_URL, accountProps)
      .then((response) => {
        console.log(response.status);
        console.log("Udalo sie utworzyć użytkownika");
      })
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      >
        ...
        <label className="form-label-input" htmlFor="salary">
          <input
            className="form-input"
            id="salary"
            value={salary}
        ...
        <label className="form-label-input" htmlFor="gender">
          <input
            className="form-input"
            id="gender"
            value={gender}
        ...
        <label className="form-label-input" htmlFor="dateOfEmployment">
          <input
            className="form-input"
            id="dateOfEmployment"
