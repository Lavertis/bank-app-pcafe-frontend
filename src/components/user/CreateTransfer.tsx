...
export const CreateTransfer: FC<RegisterProps> = () => {
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      >
        <label className="form-label-input" htmlFor="amount">
          <input
        ...
        <label className="form-label-input" htmlFor="receiverAccountNumber">
          <input
            className="form-input"
        ...
        <label className="form-label-input" htmlFor="receiverName">
          <input
            className="form-input"
            id="receiverName"
            value={receiverName}
        ...
        <label className="form-label-input" htmlFor="description">
          <input
            className="form-input"
            id="description"
            value={description}
        ...
        <label className="form-label-input" htmlFor="accountId">
          <input
            className="form-input"
            id="accountId"
            value={accountId}
